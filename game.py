...
class Game:
    ...
    def __init__(self, connector):
        ...
        self.typelabel = Label(self.tk, font='Times 15 bold', bg='white', fg='black',
                                       height=1, width=8)
        self.typelabel.grid(row=6,column=2)
        self.tk.geometry("414x600")
        self.tk.minsize(414,600)
        self.tk.maxsize(414,600)
        ...
        while self.connector.connected:
            ...
            if msg != "":
                ...
                if "{found}" in msg:
                    ...
                    if "{ooo}" in msg:
                        self.gameclick = "O"
                        self.typelabel.configure(text=" O ")
                    elif "{xxx}" in msg:
                        self.gameclick = "X"
                        self.typelabel.configure(text=" X ")
